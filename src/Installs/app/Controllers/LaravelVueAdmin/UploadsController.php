...
class UploadsController extends Controller
{
	...
	public function index()
	{
		...
		if(Module::hasAccess($module->id)) {
			return View('LaravelVueAdmin.uploads.index', [
        ...
        if($upload->public || Entrust::hasRole('SUPER_ADMIN') || Auth::user()->id == $upload->user_id) {
            ...
            if(isset($size)) {
                ...
                if(File::exists($thumbpath)) {
                    ...
                    // Create Thumbnail
                    LvHelper::createThumbnail($upload->path, $thumbpath, $size, $size, "transparent");
                    $path = $thumbpath;
                }
            }
			...
			if(Input::hasFile('file')) {
				...
				*/
				...
				if( $upload_success ) {
					...
					// config("LaravelVueAdmin.uploads.default_public")
    ...
    public function uploaded_files()
    {
		if(Module::hasAccess("Uploads", "view")) {
			...
			if(Entrust::hasRole('SUPER_ADMIN')) {
				...
				if(config('LaravelVueAdmin.uploads.private_uploads')) {
